...
function buildPatient(): Patient {
  return {
    ...
    active: true,
    curriculumDiagnose: "F32.1" as any,
    beruf: "Lehrerin (Sek. I)",
    triggers: ["Konflikt am Arbeitsplatz", "Beziehungsende", "Vergleich mit Peers"],
    hauptsymptome: ["Niedergeschlagenheit", "Antriebsminderung", "Anhedonie", "Schlafstörung", "Grübeln", "Konzentrationsstörung"],
    hauptangstGedanken: ["Ich bin nicht gut genug.", "Ich bin eine Belastung.", "Ich werde scheitern.", "Niemand braucht mich."],
    vermeidungsVerhalten: ["Sozialkontakte meiden", "Hobbies aufgegeben", "Aufgaben aufschieben"],
    ressourcen: ["Schwester als Bezugsperson", "sprachlich reflektiert", "frühere Hobbies (Chor, Yoga)"],
    lernstil: "lesen",
